...
class LlmCall(Base):
    ...
    file_version: Mapped[str | None] = mapped_column(ForeignKey("file_version.version", ondelete="SET NULL"))
    summary_id: Mapped[int | None] = mapped_column(ForeignKey("summary.id", ondelete="SET NULL"))
